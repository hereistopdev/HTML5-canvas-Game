Gauntlet = function () {
  ...
  var VERSION = "1.0.0",
    ...
    MONSTER = {
      ...
      WIZARD: {
        ...
        canbeshot: true,
        canbehit: true,
        invisibility: { on: 3 * FPS, off: 6 * FPS },
        travelling: 0.5 * FPS,
        thinking: 0.5 * FPS,
        generator: {
          health: 24,
  ...
  PREFERRED_DIRECTIONS[DIR.UPLEFT] = [
    DIR.UPLEFT,
    DIR.LEFT,
    DIR.UP,
    DIR.UPRIGHT,
  ...
  PREFERRED_DIRECTIONS[DIR.UPRIGHT] = [
    DIR.UPRIGHT,
    DIR.RIGHT,
    DIR.UP,
    DIR.UPLEFT,
  ...
  PREFERRED_DIRECTIONS[DIR.DOWNLEFT] = [
    DIR.DOWNLEFT,
    DIR.LEFT,
    DIR.DOWN,
    DIR.UPLEFT,
  ...
  PREFERRED_DIRECTIONS[DIR.DOWNRIGHT] = [
    DIR.DOWNRIGHT,
    DIR.RIGHT,
    DIR.DOWN,
    DIR.DOWNLEFT,
  ...
  PREFERRED_DIRECTIONS[DIR.RIGHT] = [
    DIR.RIGHT,
    DIR.UPRIGHT,
    DIR.DOWNRIGHT,
    DIR.UP,
  ...
  var cfg = {
    ...
    pubsub: [
      {
        event: EVENT.MONSTER_DEATH,
        action: function (monster, by, nuke) {
          this.onMonsterDeath(monster, by, nuke);
        },
      },
      {
        event: EVENT.GENERATOR_DEATH,
        action: function (generator, by) {
          this.onGeneratorDeath(generator, by);
        },
      },
      {
        event: EVENT.DOOR_OPENING,
        action: function (door, speed) {
          this.onDoorOpening(door, speed);
        },
      },
      {
        event: EVENT.DOOR_OPEN,
        action: function (door) {
          this.onDoorOpen(door);
        },
      },
      {
        event: EVENT.TREASURE_COLLECTED,
        action: function (treasure, player) {
          this.onTreasureCollected(treasure, player);
        },
      },
      {
        event: EVENT.WEAPON_COLLIDE,
        action: function (weapon, entity) {
          this.onWeaponCollide(weapon, entity);
        },
      },
      {
        event: EVENT.PLAYER_COLLIDE,
        action: function (player, entity) {
          this.onPlayerCollide(player, entity);
        },
      },
      {
        event: EVENT.MONSTER_COLLIDE,
        action: function (monster, entity) {
          this.onMonsterCollide(monster, entity);
        },
      },
      {
        event: EVENT.PLAYER_NUKE,
        action: function (player) {
          this.onPlayerNuke(player);
        },
      },
      {
        event: EVENT.PLAYER_FIRE,
        action: function (player) {
          this.onPlayerFire(player);
        },
      },
      {
        event: EVENT.MONSTER_FIRE,
        action: function (monster) {
          this.onMonsterFire(monster);
        },
      },
      {
        event: EVENT.PLAYER_EXITING,
        action: function (player, exit) {
          this.onPlayerExiting(player, exit);
        },
      },
      {
        event: EVENT.PLAYER_EXIT,
        action: function (player) {
          this.onPlayerExit(player);
        },
      },
      {
        event: EVENT.FX_FINISHED,
        action: function (fx) {
          this.onFxFinished(fx);
        },
      },
      {
        event: EVENT.PLAYER_DEATH,
        action: function (player) {
    ...
    sounds: [
      {
        id: "lostcorridors",
        name: "sounds/music.lostcorridors",
        formats: ["mp3", "ogg"],
        volume: 1.0,
        loop: true,
      ...
      {
        id: "fleshandsteel",
        name: "sounds/music.fleshandsteel",
        formats: ["mp3", "ogg"],
        volume: 0.5,
        loop: true,
      }, //
      {
        id: "mountingassault",
        name: "sounds/music.mountingassault",
        formats: ["mp3", "ogg"],
        volume: 0.5,
        loop: true,
      }, //
      {
        id: "phantomdrone",
        name: "sounds/music.phantomdrone",
        formats: ["mp3", "ogg"],
        volume: 0.5,
        loop: true,
      }, //
      {
        id: "thebeginning",
        name: "sounds/music.thebeginning",
        formats: ["mp3", "ogg"],
        volume: 0.5,
        loop: true,
      }, //
      ...
      {
        id: "femalepain1",
        name: "sounds/femalepain1",
        formats: ["mp3", "ogg"],
        volume: 0.3,
      }, // http://www.premiumbeat.com/sfx/
      {
        id: "femalepain2",
        name: "sounds/femalepain2",
        formats: ["mp3", "ogg"],
        volume: 0.3,
      }, // (ditto)
      {
        id: "malepain1",
        name: "sounds/malepain1",
        formats: ["mp3", "ogg"],
        volume: 0.3,
      }, //
      {
        id: "malepain2",
        name: "sounds/malepain2",
        formats: ["mp3", "ogg"],
        volume: 0.3,
      }, //
      {
        id: "exitlevel",
        name: "sounds/exitlevel",
        formats: ["mp3", "ogg"],
        volume: 1.0,
      }, //
      {
      ...
      {
        id: "firewarrior",
        name: "sounds/firewarrior",
        formats: ["mp3", "ogg"],
        volume: 0.3,
        pool: ua.is.ie ? 2 : 4,
      }, //   NOTE: ie has limit of 40 <audio> so be careful with pool amounts
      {
        id: "firevalkyrie",
        name: "sounds/firevalkyrie",
        formats: ["mp3", "ogg"],
        volume: 0.3,
        pool: ua.is.ie ? 2 : 4,
      }, //
    ...
    levels: [
      {
        name: "Test Level",
        url: "levels/testlevel.png",
        floor: FLOOR.LIGHT_STONE,
        wall: WALL.BLUE_COBBLE,
        music: "bloodyhalo",
        score: 1000,
        help: null,
      },
      {
        name: "Training",
        url: "levels/trainer1.png",
        floor: FLOOR.LIGHT_STONE,
        wall: WALL.BLUE_COBBLE,
        music: "bloodyhalo",
        score: 1000,
        help: "Shoot ghosts and find the exit",
      },
      {
        name: "Training Two",
        url: "levels/trainer2.png",
        floor: FLOOR.LIGHT_STONE,
        wall: WALL.BLUE_COBBLE,
        music: "bloodyhalo",
        score: 1000,
        help: "Watch out for demon fire",
      },
      {
        name: "Training Three",
        url: "levels/trainer3.png",
        floor: FLOOR.LIGHT_STONE,
        wall: WALL.BLUE_COBBLE,
        music: "bloodyhalo",
        score: 1000,
      ...
      {
        name: "Training Four",
        url: "levels/trainer4.png",
        floor: FLOOR.LIGHT_STONE,
        wall: WALL.BLUE_COBBLE,
        music: "bloodyhalo",
        score: 1000,
        help: "Eat and drink to restore health",
      },
      {
        name: "Training Five",
        url: "levels/trainer5.png",
        floor: FLOOR.LIGHT_STONE,
        wall: WALL.BLUE_COBBLE,
        music: "bloodyhalo",
        score: 1000,
        help: "Collect treasure for high score",
      },
      {
        name: "Training Six",
        url: "levels/trainer6.png",
        floor: FLOOR.LIGHT_STONE,
        wall: WALL.BLUE_COBBLE,
        music: "bloodyhalo",
        score: 1000,
        help: "Destroy monster generators",
      },
      {
        name: "Training Seven",
        url: "levels/trainer7.png",
        floor: FLOOR.LIGHT_STONE,
        wall: WALL.BLUE_COBBLE,
        music: "bloodyhalo",
        score: 1000,
        help: "Use potions to destroy all monsters",
      },
      {
        name: "Dungeon One",
        url: "levels/level1.png",
        floor: FLOOR.WOOD,
        wall: WALL.CONCRETE,
        music: "citrinitas",
        score: 1000,
        help: "Training is over!<br><br> Welcome to the Dungeon!",
      },
      {
        name: "Dungeon Two",
        url: "levels/level2.png",
        floor: FLOOR.WOOD,
        wall: WALL.CONCRETE,
        music: "citrinitas",
        score: 2000,
      ...
      {
        name: "Dungeon Three",
        url: "levels/level3.png",
        floor: FLOOR.DARK_STONE,
        wall: WALL.BLUE,
        music: "fleshandsteel",
        score: 3000,
        help: null,
      ...
      {
        name: "Dungeon Five",
        url: "levels/level5.png",
        floor: FLOOR.BROWN_LAMINATE,
        wall: WALL.CONCRETE,
        music: "phantomdrone",
        score: 5000,
        help: null,
      ...
      {
        name: "Dungeon Seven",
        url: "levels/level7.png",
        floor: FLOOR.PURPLE_LAMINATE,
        wall: WALL.PURPLE_COBBLE,
        music: "thebeginning",
        score: 7000,
        help: null,
      },
      {
        name: "Dungeon Eight",
        url: "levels/level8.png",
        floor: FLOOR.WOOD,
        wall: WALL.BLUE_BRICK,
        music: "mountingassault",
        score: 8000,
        help: null,
      },
      {
        name: "Dungeon Nine",
        url: "levels/level9.png",
        floor: FLOOR.PURPLE_LAMINATE,
        wall: WALL.CONCRETE,
        music: "fleshandsteel",
        score: 9000,
      ...
      {
        name: "Dungeon Ten",
        url: "levels/level10.png",
        floor: FLOOR.WOOD,
        wall: WALL.BLUE_BRICK,
        music: "warbringer",
        score: 10000,
        help: "Final Level<br><br>Good Luck!",
      },
    ],
  ...
  function publish() {
    game.publish.apply(game, arguments);
  } // cosmetic short-hand
  function subscribe() {
    game.subscribe.apply(game, arguments);
  } // cosmetic short-hand
  ...
  function countdown(n, dn) {
    return n ? Math.max(0, n - (dn || 1)) : 0;
  } // decrement by 1, but always stop at zero, even for floating point numbers

  function isUp(dir) {
    return dir === DIR.UP || dir === DIR.UPLEFT || dir === DIR.UPRIGHT;
  }
  function isDown(dir) {
    return dir === DIR.DOWN || dir === DIR.DOWNLEFT || dir === DIR.DOWNRIGHT;
  }
  function isLeft(dir) {
    return dir === DIR.LEFT || dir === DIR.UPLEFT || dir === DIR.DOWNLEFT;
  }
  function isRight(dir) {
    return dir === DIR.RIGHT || dir === DIR.UPRIGHT || dir === DIR.DOWNRIGHT;
  }
  ...
  function animate(frame, fpf, frames) {
    return Math.round(frame / fpf) % frames;
  }

  function overlapEntity(x, y, w, h, entity) {
    return Game.Math.overlap(
      x,
      y,
      w,
      h,
      entity.x + entity.cbox.x,
  ...
  var _overlappingCells = {
      cells: [],
      getcells: function () {
        set_clear(this.cells);
        return this.cells;
      },
    },
    _occupied = {
  ...
  var game = {
    ...
    onload: function (event, previous, current, nlevel) {
      var level = cfg.levels[nlevel],
        ...
        onloaded = function () {
          $("booting").hide();
          self.play(new Map(nlevel));
        };
      if (level.source) {
        onloaded();
      } else {
        $("booting").show();
        level.source = Game.createImage(level.url + "?cachebuster=" + VERSION, {
          onload: onloaded,
        });
      }
    },
    ...
    onplay: function (event, previous, current, map) {
      ...
      if (map.level.help) this.help(map.level.help);
    },
    ...
    winlosefade: function (duration) {
      var finish = function () {
        ...
        animate = function (value) {
          game.runner.canvas.fade(1 - value);
        },
    ...
    onbeforequit: function (event, previous, current) {
      if (!confirm("Quit Game?")) return false;
    },
    ...
    onenterhelp: function (event, previous, current, msg) {
      $("help").update(msg).show();
      setTimeout(this.autoresume.bind(this), 4000);
    },
    onleavehelp: function (event, previous, current) {
      $("help").hide();
    },

    autoresume: function () {
      if (this.is("help")) this.resume();
    },
    ...
    onPlayerNuke: function (player) {
      this.map.nuke(this.viewport, player);
    },
    onFxFinished: function (fx) {
      this.map.remove(fx);
    },
    ...
    onPlayerExiting: function (player, exit) {
      ...
      if (this.map.last) this.win();
    },

    onPlayerExit: function (player) {
      if (!this.map.last) this.nextLevel();
    },
    ...
    onWeaponCollide: function (weapon, entity) {
      ...
      if (weapon.type.player && (entity.monster || entity.generator))
        ...
        entity.hurt(weapon.type.damage, weapon);
      else if (weapon.type.monster && entity.monster) entity.hurt(1, weapon);
    ...
    onPlayerCollide: function (player, entity) {
      ...
      else if (entity.treasure) player.collect(entity);
      else if (entity.door && player.keys && entity.open()) player.keys--;
      else if (entity.exit) player.exit(entity);
    },

    onMonsterCollide: function (monster, entity) {
      if (entity.player) {
        entity.hurt(monster.type.damage, monster);
        if (monster.type.selfharm) monster.hurt(monster.type.selfharm, monster);
      }
    },

    onMonsterDeath: function (monster, by, nuke) {
      if (by) by.addscore(monster.type.score);
      this.map.addMultipleFx(
        3,
        monster,
        FX.MONSTER_DEATH,
        TILE / 2,
    ...
    onGeneratorDeath: function (generator, by) {
      if (by) by.addscore(generator.type.score);
    ...
    saveLevel: function (nlevel) {
      this.storage[STORAGE.NLEVEL] = nlevel;
    },
    loadLevel: function () {
      return to.number(this.storage[STORAGE.NLEVEL], 1);
    },
    nextLevel: function () {
    ...
    prevLevel: function () {
      var n = this.map.nlevel - 1;
      this.load(n <= 0 ? cfg.levels.length - 1 : n);
    },

    loadHighScore: function () {
      return to.number(this.storage[STORAGE.SCORE], 10000);
    },
    loadHighWho: function () {
      return this.storage[STORAGE.WHO];
    },
    ...
    debugWall: function (back) {
      DEBUG.WALL = (DEBUG.WALL || this.map.level.wall) + (back ? -1 : 1);
      if (DEBUG.WALL > WALL.MAX) DEBUG.WALL = WALL.MIN;
      if (DEBUG.WALL < WALL.MIN) DEBUG.WALL = WALL.MAX;
      console.log("WALL = " + DEBUG.WALL);
      this.map.background = null;
    },
    debugFloor: function (back) {
      DEBUG.FLOOR = (DEBUG.FLOOR || this.map.level.floor) + (back ? -1 : 1);
      if (DEBUG.FLOOR > FLOOR.MAX) DEBUG.FLOOR = FLOOR.MIN;
      if (DEBUG.FLOOR < FLOOR.MIN) DEBUG.FLOOR = FLOOR.MAX;
      console.log("FLOOR = " + DEBUG.FLOOR);
      this.map.background = null;
    },
    debugGrid: function () {
    ...
    clean: function (storage) {
      if (DEBUG.RESET || storage[STORAGE.VERSION] != VERSION) {
        for (var key in STORAGE) delete storage[STORAGE[key]];
  ...
  var Map = Class.create({
    ...
    trymove: function (entity, dir, speed, ignore, dryrun) {
      var collision;
      this.tpos.x =
        entity.x + (isLeft(dir) ? -speed : isRight(dir) ? speed : 0);
      this.tpos.y = entity.y + (isUp(dir) ? -speed : isDown(dir) ? speed : 0);
      collision = this.occupied(
        this.tpos.x + entity.cbox.x,
        this.tpos.y + entity.cbox.y,
        entity.cbox.w,
        entity.cbox.h,
        ignore || entity
      );
    ...
    canmove: function (entity, dir, speed, ignore) {
      if (false === this.trymove(entity, dir, speed, ignore, true))
        return this.tpos;
      // caller is responsible for using result immediately and NOT holding a reference to the object
      else return false;
    },
    ...
    occupy: function (x, y, obj) {
      ...
      if (obj.temporal) return;

      var c,
        max,
        cell,
        before = obj.cells,
        after = this.overlappingCells(x, y, TILE, TILE);
      ...
      for (c = 0, max = before.length; c < max; c++) {
        cell = before[c];
        if (!set_contains(after, cell)) set_remove(cell.occupied, obj);
      }

      // and add object to new cells that were not previously occupied
      for (c = 0, max = after.length; c < max; c++) {
        cell = after[c];
        if (!set_contains(before, cell)) set_add(cell.occupied, obj);
      }
    ...
    nuke: function (viewport, player) {
      var n,
        ...
        entity,
        distance,
        limit = TILE * player.type.magic;
      for (n = 0, max = this.entities.length; n < max; n++) {
        entity = this.entities[n];
        if (entity.monster && entity.active) {
          distance = Math.max(
            Math.abs(player.x - entity.x),
            Math.abs(player.y - entity.y)
          ); // rough, but fast, approximation for slower, sqrt(x*x + y*y)
          if (distance < limit)
            entity.hurt(
              player.type.magic * (1 - distance / limit),
              player,
              true
            );
        }
    ...
    setupLevel: function (nlevel) {
      ...
      function isnothing(pixel) {
        return is(pixel, PIXEL.NOTHING);
      }
      function iswall(pixel) {
        return is(pixel, PIXEL.WALL);
      }
      function isstart(pixel) {
        return is(pixel, PIXEL.START);
      }
      function isdoor(pixel) {
        return is(pixel, PIXEL.DOOR);
      }
      function isexit(pixel) {
        return is(pixel, PIXEL.EXIT);
      }
      function isgenerator(pixel) {
        return is(pixel, PIXEL.GENERATOR);
      }
      function ismonster(pixel) {
        return is(pixel, PIXEL.MONSTER);
      }
      function istreasure(pixel) {
        return is(pixel, PIXEL.TREASURE);
      }
      function walltype(tx, ty, map) {
        return (
          (iswall(map.pixel(tx, ty - 1)) ? 1 : 0) |
          (iswall(map.pixel(tx + 1, ty)) ? 2 : 0) |
          (iswall(map.pixel(tx, ty + 1)) ? 4 : 0) |
          (iswall(map.pixel(tx - 1, ty)) ? 8 : 0)
        );
      }
      function shadowtype(tx, ty, map) {
        return (
          (iswall(map.pixel(tx - 1, ty)) ? 1 : 0) |
          (iswall(map.pixel(tx - 1, ty + 1)) ? 2 : 0) |
          (iswall(map.pixel(tx, ty + 1)) ? 4 : 0)
        );
      }
      function doortype(tx, ty, map) {
        return iswall(map.pixel(tx, ty - 1)) || isdoor(map.pixel(tx, ty - 1))
          ? DOOR.VERTICAL
          : DOOR.HORIZONTAL;
      }
      ...
      Game.parseImage(source, function (tx, ty, pixel, map) {
        ...
        if (isstart(pixel)) self.start = { x: x, y: y };

        if (iswall(pixel)) cell.wall = walltype(tx, ty, map);
        else if (isnothing(pixel)) cell.nothing = true;
        else cell.shadow = shadowtype(tx, ty, map);

        if (isexit(pixel)) self.addExit(x, y, DOOR.EXIT);
        else if (isdoor(pixel)) self.addDoor(x, y, doortype(tx, ty, map));
        else if (isgenerator(pixel))
          self.addGenerator(
            x,
            y,
            MONSTERS[type(pixel) < MONSTERS.length ? type(pixel) : 0]
          );
        else if (istreasure(pixel))
          self.addTreasure(
            x,
            y,
            TREASURES[type(pixel) < TREASURES.length ? type(pixel) : 0]
          );
    ...
    addGenerator: function (x, y, type) {
      return DEBUG.NOGENERATORS ? null : this.add(x, y, Generator, null, type);
    },
    addTreasure: function (x, y, type) {
      return DEBUG.NOTREASURE ? null : this.add(x, y, Treasure, null, type);
    },
    addDoor: function (x, y, type) {
      return DEBUG.NODOORS ? null : this.add(x, y, Door, null, type);
    },
    addExit: function (x, y, type) {
      return DEBUG.NOEXITS ? null : this.add(x, y, Exit, null, type);
    },
    addWeapon: function (x, y, type, dir, owner) {
      return DEBUG.NOWEAPONS
        ? null
        : this.add(x, y, Weapon, this.pool.weapons, type, dir, owner);
    },
    addMonster: function (x, y, type, generator) {
      return DEBUG.NOMONSTERS
        ? null
        : this.add(x, y, Monster, this.pool.monsters, type, generator);
    },
    addFx: function (x, y, type, delay) {
      return DEBUG.NOFX ? null : this.add(x, y, Fx, this.pool.fx, type, delay);
    },
    ...
    addMultipleFx: function (count, target, type, d, dt) {
      ...
      for (n = 0; n < 1000; n++) {
        ...
        if (collision !== true) {
          // allow it unless its explicitly a wall
  ...
  var Monster = Class.create({
    ...
    update: function (frame, player, map, viewport) {
      ...
      if (this.thinking && --this.thinking) return;
      ...
      for (n = 0, max = dirs.length; n < max; n++) {
        if (
          this.step(
            ...
            dirs[n],
            speed,
            n < 2 ? 0 : this.type.travelling * (n - 2),
            !away
          )
        )
          return;
    ...
    hurt: function (damage, by, nuke) {
      if (
        (by.weapon && this.type.canbeshot) ||
        (by.player && this.type.canbehit) ||
        by == this ||
        nuke
      ) {
        ...
        if (this.health === 0)
          this.die(
            by.player ? by : by.weapon && by.type.player ? by.owner : null,
            nuke
          );
      }
    },
    ...
    die: function (by, nuke) {
      if (this.generator) this.generator.remove(this);
    ...
    directionTo: function (target, away) {
      ...
      else if (up && right) return away ? DIR.DOWNLEFT : DIR.UPRIGHT;
      else if (down && left) return away ? DIR.UPRIGHT : DIR.DOWNLEFT;
      else if (down && right) return away ? DIR.UPLEFT : DIR.DOWNRIGHT;
      else if (up) return away ? DIR.DOWN : DIR.UP;
      else if (down) return away ? DIR.UP : DIR.DOWN;
      else if (left) return away ? DIR.RIGHT : DIR.LEFT;
      else if (right) return away ? DIR.LEFT : DIR.RIGHT;
    ...
    onrender: function (frame) {
      if (
        ...
        (frame + this.df) %
          (this.type.invisibility.on + this.type.invisibility.off) <
          this.type.invisibility.on
      )
        return false;

      this.frame =
        this.dir +
        8 * animate(frame + this.df, this.type.fpf, this.type.frames);
    },
  });
  ...
  var Weapon = Class.create({
    ...
    update: function (frame, player, map, viewport) {
      ...
      if (collision) {
        this.owner.reloading = countdown(
          this.owner.reloading,
          this.type.reload / 2
        ); // speed up reloading process if previous weapon hit something, makes player feel powerful
        publish(EVENT.WEAPON_COLLIDE, this, collision);
      }
    },

    onrender: function (frame) {
      this.frame = this.type.rotate
        ? animate(frame, this.type.fpf, 8)
        : this.dir;
    },
  });
  ...
  var Fx = Class.create({
    ...
    update: function (frame, player, map, viewport) {
      ...
      if (this.frame === this.type.frames) publish(EVENT.FX_FINISHED, this);
    },
  ...
  var Player = Class.create({
    ...
    update: function (frame, player, map, viewport) {
      ...
      if (this.exiting) {
        if (--this.exiting.count === 0) publish(EVENT.PLAYER_EXIT, this);
        return;
      }
      ...
      if (is.invalid(this.moving.dir)) return;
      ...
      for (d = 0, dmax = directions.length; d < dmax; d++) {
        ...
        if (collision) publish(EVENT.PLAYER_COLLIDE, this, collision);
        // if we collided with something, publish event and then try next available direction...
        else return; // ... otherwise we moved, so we're done trying
      }
    },
    ...
    collect: function (treasure) {
      ...
      else if (treasure.type.key) this.keys++;
      else if (treasure.type.health) this.heal(treasure.type.health);
      else if (treasure.type.damage) this.hurt(treasure.type.damage);
    ...
    moveDown: function (on) {
      this.moving.down = on;
      this.setDir();
    },
    moveLeft: function (on) {
      this.moving.left = on;
      this.setDir();
    },
    moveRight: function (on) {
      this.moving.right = on;
      this.setDir();
    },
    ...
    setDir: function () {
      ...
      else if (this.moving.up) this.dir = this.moving.dir = DIR.UP;
      else if (this.moving.down) this.dir = this.moving.dir = DIR.DOWN;
      else if (this.moving.left) this.dir = this.moving.dir = DIR.LEFT;
      else if (this.moving.right) this.dir = this.moving.dir = DIR.RIGHT;
      else this.moving.dir = null; // no moving.dir, but still facing this.dir
    },
    ...
    autohurt: function (frame) {
      if (!DEBUG.NOAUTOHURT && frame % (FPS / 2) === 0)
    ...
    onrender: function (frame) {
      if (this.dead) this.frame = 32;
      else if (this.exiting)
        this.frame =
          this.type.sx + animate(this.exiting.count, this.exiting.fpf, 8);
      else if (is.valid(this.moving.dir) || this.firing)
        this.frame =
          this.type.sx +
          this.dir +
          8 * animate(frame, this.type.fpf, this.type.frames);
      else this.frame = this.type.sx + this.dir;
    },
  });
  ...
  var Scoreboard = Class.create({
    ...
    initialize: function (level, score, who) {
      ...
      var p1 = this.warrior.down(".press b"),
        ...
        pressN = new Animator({ repeat: "toggle", duration: 500 }).addSubject(
          function (value) {
            p1.fade(value);
            p2.fade(value);
            p3.fade(value);
    ...
    highScoreDom: function () {
      var score = this.dom.down(".high .value"),
        ...
        }).addSubject(function (value) {
          who.fade(1 - value * 0.8);
        });
    ...
    onPlayerJoin: function (player) {
      player.vhealth =
        ...
        player.vkeys =
        player.vpotions =
          null; // reset any cached 'visual' values
    ...
    formatHealth: function (n) {
      return to.string(Math.floor(n));
    },
    formatScore: function (n) {
      return ("000000" + Math.floor(n)).slice(-6);
    },
    ...
    activateHighScore: function () {
      this.high.active = true;
      this.high.dom.flash.play();
    },
    deactivateHighScore: function () {
      this.high.active = false;
      this.high.dom.flash.stop();
    },
    ...
    refreshPlayerScore: function (player) {
      if (player.score != player.vscore) {
        player.type.dom.score.update(
          this.formatScore(
            (player.vscore = this.inc(player.vscore, player.score))
          )
        );
    ...
    refreshPlayerHealth: function (player) {
      if (player.health != player.vhealth)
        player.type.dom.health.update(
          this.formatHealth(
            (player.vhealth = this.inc(player.vhealth, player.health))
          )
        );
    },
    ...
    refreshPlayerWeak: function (player) {
      if (player.weak() != player.vweak) {
        if ((player.vweak = player.weak())) player.type.dom.weak.play();
        else player.type.dom.weak.stop();
      }
    },
    ...
    refreshPlayerKeys: function (player) {
      if (player.keys != player.vkeys)
        this.refreshTreasure(
          player.type.dom.keys,
          (player.vkeys = player.keys)
        );
    },
    ...
    refreshPlayerPotions: function (player) {
      if (player.potions != player.vpotions)
        this.refreshTreasure(
          player.type.dom.potions,
          (player.vpotions = player.potions)
        );
    },
  ...
  var Viewport = Class.create({
    ...
    size: function (tw, map) {
      this.tw = Game.Math.minmax(
        tw,
        18,
        map.th < map.tw ? map.tw : map.th * (VIEWPORT.TW / VIEWPORT.TH)
      );
    ...
    update: function (frame, player, map, viewport) {
      ...
      if (this.zoomingout) this.zoom(1 / TILE, player, map);
    },
  });
  ...
  var Render = Class.create({
    ...
    map: function (ctx, frame, viewport, map) {
      ...
      map.background =
        map.background ||
        Game.renderToCanvas(map.w, map.h, this.maptiles.bind(this, map));
    ...
    maptiles: function (map, ctx) {
      var n,
        ...
        tw,
        th,
        sprites = this.sprites.backgrounds;
        ...
        for (tx = 0, tw = map.tw; tx < tw; tx++) {
          ...
          if (is.valid(cell.wall))
            this.tile(
              ...
              sprites,
              cell.wall,
              DEBUG.WALL || map.level.wall,
              tx,
              ty
            );
          else if (cell.nothing) this.tile(ctx, sprites, 0, 0, tx, ty);
          else
      ...
      if (DEBUG.GRID) this.grid(ctx, map);
    },
      ...
      if (player.onrender(frame) !== false) {
        var sprites = this.sprites.entities,
          ...
          exiting = player.exiting
            ? (player.exiting.max - player.exiting.count) / player.exiting.max
            : 0,
        ...
        if (exiting > 0.5)
          // player is 'gone' once halfway through exit
          return;

        if (hurt || heal) {
          border = Math.ceil(
            maxglow * ((hurt || heal) / FX.PLAYER_GLOW.frames)
          );
        ...
        player.ctx.globalAlpha =
          1 - (weak ? player.type.dom.weak.state * 0.9 : 0); // piggy back the DOM scoreboard animator (but dont go completely transparent)
        player.ctx.drawImage(
          sprites,
          sx * STILE,
          sy * STILE,
        ...
        ctx.drawImage(
          ...
          STILE + 2 * maxglow,
          STILE + 2 * maxglow,
          x + dx - maxglow + shrink / 2 - viewport.x,
          y + dy - maxglow + shrink / 2 - viewport.y,
          TILE + 2 * maxglow - shrink,
          TILE + 2 * maxglow - shrink
        );
      }
    },
    ...
    entities: function (ctx, frame, viewport, entities) {
      var n,
        ...
        entity,
        sf,
        sprites = this.sprites.entities;
      for (n = 0, max = entities.length; n < max; n++) {
        entity = entities[n];
        if (
          entity.active &&
          (!entity.onrender || entity.onrender(frame) !== false) &&
          !viewport.outside(entity.x, entity.y, TILE, TILE)
        ) {
          this.sprite(
            ctx,
            sprites,
            viewport,
            entity.type.sx + (entity.frame || 0),
            entity.type.sy,
            entity.x + (entity.dx || 0),
            entity.y + (entity.dy || 0),
            TILE + (entity.dw || 0),
            TILE + (entity.dh || 0)
          );
        }
  ...
  var Sounds = Class.create({
    ...
    onStartLevel: function (map) {
      this.playGameMusic(this.sounds[DEBUG.MUSIC || map.level.music]);
      this.nlevel = map.nlevel;
    },
    onPlayerFire: function (player) {
      this.play(this.sounds["fire" + player.type.name]);
    },
    onMonsterFire: function (monster) {
      this.play(this.sounds.fire);
    },
    onDoorOpen: function (door) {
      this.play(this.sounds.opendoor);
    },
    onTreasureCollected: function (treasure, player) {
    ...
    onMonsterDeath: function (monster, by, nuke) {
      this.play(
        nuke
          ? this.sounds.generatordeath
          : this.sounds["monsterdeath" + Game.Math.randomInt(1, 3)]
      );
    },
    onGeneratorDeath: function (generator, by) {
      this.play(this.sounds.generatordeath);
    },
    onHighScore: function (player) {
      this.play(this.sounds.highscore);
    },
    onPlayerNuke: function (player) {
    ...
    onPlayerExiting: function (player, exit) {
      ...
      if (this.nlevel === cfg.levels.length - 1) {
        ...
        cfg.levels[this.nlevel].music != cfg.levels[this.nlevel + 1].music
      ) {
    ...
    onPlayerHurt: function (player, damage) {
      if (!player.hurtSound || player.hurtSound.ended)
        // only play 1 at a time
        player.hurtSound = this.play(
          this.sounds[player.type.sex + "pain" + Game.Math.randomInt(1, 2)]
        );
    },
    ...
    toggleMusic: function () {
      if (AudioFX.mute) this.stopAllMusic();
      else if (game.is("menu")) this.playMenuMusic();
      else if (game.is("loading") || game.is("playing") || game.is("lost"))
        this.playGameMusic();
    },

    isMute: function () {
      return to.bool(game.storage.mute);
    },
    isNotMute: function () {
      return !this.isMute();
    },
    play: function (s) {
      if (this.isNotMute()) return s.play();
    },
    ...
    playGameMusic: function (sound) {
      if (
        !sound ||
        sound !== this.sounds.game ||
        sound.audio.ended ||
        sound.audio.paused
      ) {
        // skip if specified game sound is already playing (leave it playing, dont restart it)
        this.stopAllMusic();
